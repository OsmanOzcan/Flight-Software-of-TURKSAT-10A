...
int main()
{
	...
	while (1){
		...
		*/
		...
		FILE *ms5611WriteDosya = fopen("/home/pi/Desktop/TURKSAT/MS5611datas.txt", "w");  // w => Üzerine yaz	
		fprintf(ms5611WriteDosya, "%f %f %f %f", fltd_Temparature, fltd_Pressure*100, Altitude, roc/100.0);
		fclose(ms5611WriteDosya);
